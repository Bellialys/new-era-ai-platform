...
const REQUIRED_COLUMNS = [
  ...
  { table: "usage_events",            column: "model_key" },
  { table: "usage_events",            column: "latency_ms" },
  { table: "usage_events",            column: "cost_usd" },
  { table: "usage_events",            column: "created_at" },
  { table: "team_runs",               column: "id" },
  { table: "team_runs",               column: "task_id" },
  { table: "team_runs",               column: "user_id" },
  { table: "team_runs",               column: "model_key" },
  { table: "team_runs",               column: "status" },
  { table: "team_runs",               column: "final_answer" },
  { table: "team_runs",               column: "created_at" },
  { table: "team_run_steps",          column: "id" },
  { table: "team_run_steps",          column: "team_run_id" },
  { table: "team_run_steps",          column: "role_id" },
  { table: "team_run_steps",          column: "role_label" },
  { table: "team_run_steps",          column: "prompt" },
  { table: "team_run_steps",          column: "response" },
  { table: "team_run_steps",          column: "created_at" },
  { table: "code_runs",               column: "id" },
  { table: "code_runs",               column: "user_id" },
  { table: "code_runs",               column: "language" },
  { table: "code_runs",               column: "code" },
  { table: "code_runs",               column: "stdout" },
  { table: "code_runs",               column: "stderr" },
  { table: "code_runs",               column: "exit_code" },
  { table: "code_runs",               column: "created_at" },
  { table: "leaderboard_snapshots",   column: "id" },
  { table: "leaderboard_snapshots",   column: "snapshot_date" },
  { table: "leaderboard_snapshots",   column: "model_key" },
  { table: "leaderboard_snapshots",   column: "model_display_name" },
  { table: "leaderboard_snapshots",   column: "win_rate" },
  { table: "leaderboard_snapshots",   column: "created_at" },
  { table: "artifacts",               column: "id" },
  { table: "artifacts",               column: "user_id" },
  { table: "artifacts",               column: "artifact_type" },
  { table: "artifacts",               column: "storage_path" },
  { table: "artifacts",               column: "mime_type" },
  { table: "artifacts",               column: "created_at" },
  { table: "model_price_history",     column: "id" },
  { table: "model_price_history",     column: "model_key" },
  { table: "model_price_history",     column: "input_price_per_million" },
  { table: "model_price_history",     column: "effective_from" },
  { table: "model_price_history",     column: "created_at" },
  { table: "cleanup_log",             column: "id" },
