...
Статус: **планирование** (v1.8 ещё в разработке; этот документ — ориентир для PR18–PR22).
...
model_key      → OpenRouter model key (напр. "google/gemini-flash-1.5")
...
TEAM_DEFAULT_MODEL_ID: "google/gemini-flash-1.5",
