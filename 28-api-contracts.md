...
| `GET /api/leaderboard` | 60 req | 60 сек | IP-адрес (`x-forwarded-for` → `x-real-ip`) |
| `POST /api/stream-compare` | 10 req / 5 guest req | 60 сек | user UUID или guest cookie `na_guest` |
