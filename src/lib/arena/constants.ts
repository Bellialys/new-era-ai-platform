...
export const ARENA_CONSTANTS = {
  ...
  // Admin write routes mutate control-plane state; keep stricter than admin reads.
  ADMIN_MUTATION_RATE_LIMIT_WINDOW_MS: 60_000,
  ADMIN_MUTATION_RATE_LIMIT_MAX_REQUESTS: 10,
